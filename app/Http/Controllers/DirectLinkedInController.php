...
class DirectLinkedInController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->organizationId = env('LINKEDIN_ORGANIZATION_ID', '5070168');
        $this->clientId = env('LINKEDIN_CLIENT_ID', 'REMOVED');
        $this->clientSecret = env('LINKEDIN_CLIENT_SECRET', 'REMOVED');
