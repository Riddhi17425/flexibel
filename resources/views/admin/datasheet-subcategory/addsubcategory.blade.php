...
<div class="container-xxl">
    ...
    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="{{ route('datasheet-subcategory.store') }}">
            @csrf
                ...
                <div class="card mb-3 p-3">
                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="subcategory_name" required class="form-control">
                        </div>
                        <div class="col-md-6">
