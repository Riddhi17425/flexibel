...
<div class="container-xxl">
    ...
    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="{{ route('what-we-do.update', $data->id) }}">
            @csrf
            @method('PUT')
                            ...
                            <div class="card-body">
                                <div class="row g-3 align-items-center">
                                    <div class="col-md-12">
                                        ...
                                        <input type="file" id="input-file-front-desktop" name="image" class="dropify"
                                            data-default-file="{{ asset('public/WhatWeDo/desktop/'. $data->image) }}">
                                    </div>
                                    @if ($errors->has('image'))
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="row g-3 align-items-center">
                                    <div class="col-md-12">
                                        <label class="form-label" for="input-file-front">Image Upload</label>
                                        <input type="file" id="input-file-front-mobile" name="mobile_image" class="dropify"
                                            data-default-file="{{ asset('public/WhatWeDo/mobile/' . $data->mobile_image) }}">
                                    </div>
