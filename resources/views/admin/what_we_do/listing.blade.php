    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">What We Do</h3>

                <div class="row align-items-center mb-3">
                    <div class="col-md-12">
                        <a href="{{ route('what-we-do.create') }}" class="btn btn-primary">Add What We Do</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card border-0 mb-1">
                    <div class="card-body d-flex align-items-center flex-column flex-md-row">
                        ...
                        <div class="ms-auto d-none d-md-flex">
                            <a href="{{ route('what-we-do.edit', $item) }}" class="btn btn-warning me-2">Edit</a>
                            <form action="{{ route('what-we-do.destroy', $item) }}" method="POST">
                                @csrf
                                @method('DELETE')
