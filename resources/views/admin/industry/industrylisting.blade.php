                ...
                <div class="card border-0 mb-1">
                    <div class="card-body d-flex align-items-center flex-column flex-md-row">
                        <div class="ms-md-4 m-0 mt-4 mt-md-0 text-md-start text-center w-100">
                            <h6 class="mb-3 fw-bold">{{ $industry->industry_name }} <span
                                    class="text-muted small fw-light d-block">Reference {{ $industry->id }}</span></h6>

                        </div>
                        <div class="ms-auto d-none d-md-flex">
                            <a href="{{ route('industry.edit', $industry) }}" class="btn btn-warning me-2">Edit</a>
