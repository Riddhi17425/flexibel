                ...
                <div class="card mb-3 p-3">
                    ...
                    <div class="row g-3 align-items-center">
                        <div class="col-md-6">
                            ...
                            <input type="text" id="industry_name" name="industry_name" value="{{ $data->industry_name }}" required
                                class="form-control">
                        </div>

                        <div class="col-md-12">
                            <label for="description" class="form-label">Industry Description</label>
                            <textarea id="description" name="description"
                                class="form-control">{{ $data->description }}</textarea>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Meta Title</label>
                            <input type="text" id="meta_title" name="meta_title" value="{{ $data->meta_title }}" required
                                class="form-control">
                        </div>
                        <div class="col-md-6">
                                ...
                                <div class="row g-3 align-items-center">
                                    <div class="col-md-12">
                                        ...
                                        <input type="file" id="input-file-front" name="image" class="dropify"
                                            data-default-file="{{ asset('public/industry_images/' . $data->image) }}">
                                    </div>
                                    @if ($errors->has('image'))
