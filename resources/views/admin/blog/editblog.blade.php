            ...
            <div class="col-xl-12 col-lg-8">
                <div class="card mb-3 p-3">
                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="card mb-3">
                            <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                                <h6 class="mb-0 fw-bold">Blog Banner Image</h6>
                            </div>
                            <div class="card-body">
                                <div class="row g-3 align-items-center">
                                    <div class="col-md-12">
                                        <label class="form-label" for="input-file-front">Blog Banner Image Upload</label>
                                        <input type="file" id="input-file-front" name="banner_image" class="dropify"
                                            data-default-file="{{ asset('public/blogs/banner_image/' . $data->banner_image) }}">
                                    </div>
