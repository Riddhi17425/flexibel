                ...
                <div class="card mb-3 p-3">
                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="front_alt_tag" name="front_alt_tag" class="form-control">
                        </div>
                        <div class="col-md-6">
                        ...
                        <!--    <input type="text" id="slider_top_title" name="slider_top_title" class="form-control">-->
                        <!--</div>-->
                        <!--<div class="col-md-12">-->
                        <!--    <label for="description" class="form-label">description</label>-->
                        <!--    <textarea id="slider_description" name="slider_description" class="form-control"></textarea>-->
                        <!--</div>-->
                        <!--<div class="col-md-12">-->
                        <!--    <label class="form-label">CTA Images, Alt, Titles & Descriptions</label>-->
                        <!--    <div id="imageInputs">-->
                        <!--        <div class="row mb-3">-->
