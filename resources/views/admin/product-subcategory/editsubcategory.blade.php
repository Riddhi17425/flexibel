...
<div class="container-xxl">
    ...
    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="{{ route('product-subcategory.update', $data->id) }}">
            @csrf
            @method('PUT')
                ...
                <div class="card mb-3 p-3">
                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea id="short_description" name="short_description"class="form-control summernote">{{ $data->short_description }}</textarea>
                        </div>
                        <div class="col-md-12">
                            <label for="long_description" class="form-label">Long Description</label>
                            <textarea id="long_description" name="long_description"class="form-control summernote">{{ $data->long_description }}</textarea>
                        </div>
                        <div class="card-body">
                            <div class="row g-3 align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <input type="file" id="input-file-front" name="image" class="dropify"
                                        data-default-file="{{ asset('public/product_subcategory/image/' . $data->image) }}">
                                </div>
                                @if ($errors->has('image'))
