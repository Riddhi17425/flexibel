    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">clientsays Add</h3>
            </div>
        </div>
    </div> <!-- Row end -->

    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="{{ route('clientsays.store') }}">
            @csrf
                ...
                <div class="card mb-3 p-3">
                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="file" id="client_logo" name="client_logo" class="form-control">
                        </div>
                        <div class="col-md-12">
                            <label class="form-label" for="main_images">main images</label>
                            <input type="file" id="main_images" name="main_images" class="form-control">
                        </div>
                        <div class="col-md-12">
