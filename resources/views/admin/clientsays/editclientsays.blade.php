    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">Edit clientsays</h3>
            </div>
        </div>
    </div>

    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="{{ route('clientsays.update', $data->id) }}">
            @csrf
            @method('PUT')
            ...
            <div class="col-xl-12 col-lg-8">
                <div class="card mb-3 p-3">
                    <div class="card-header py-3 p-0 d-flex justify-content-between bg-transparent border-bottom-0">
                        <h6 class="mb-0 fw-bold">clientsays Information</h6>
                    </div>
                    <div class="row g-3 align-items-center">
                        <div class="col-md-6">
                            <label class="form-label">clientsays Name</label>
                            <input type="text" id="title" name="title" value="{{ $data->title }}" required
                                class="form-control">
                        </div>

                        <div class="col-md-6">
                            <label for="designation" class="form-label">clientsays designation</label>
                        ...
                        <div class="card mb-3">
                            <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                                <h6 class="mb-0 fw-bold">client logo</h6>
                            </div>
                            <div class="card-body">
                                <div class="row g-3 align-items-center">
                                    <div class="col-md-12">
                                        <label class="form-label" for="input-file-front">client logo Upload</label>
                                        <input type="file" id="input-file-front" name="image" class="dropify"
                                            data-default-file="{{ asset('public/clientsays_client_logo/' . $data->client_logo) }}">
                                    </div>
                        ...
                        <div class="card mb-3">
                            <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                                <h6 class="mb-0 fw-bold">main images</h6>
                            </div>
                            <div class="card-body">
                                <div class="row g-3 align-items-center">
                                    <div class="col-md-12">
                                        <label class="form-label" for="input-file-front">main images Upload</label>
                                        <input type="file" id="input-file-front" name="main_images" class="dropify"
                                            data-default-file="{{ asset('public/clientsays_main_images/' . $data->main_images) }}">
                                    </div>
                                    @if ($errors->has('main_images'))
                                    <span class="text-danger">{{ $errors->first('main_images') }}</span>
                                    @endif
                                </div>
                            </div>
                        </div>
                        <div class="card mb-3">
                            <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                                <h6 class="mb-0 fw-bold">company logo</h6>
                            </div>
                            <div class="card-body">
                                <div class="row g-3 align-items-center">
                                    <div class="col-md-12">
                                        <label class="form-label" for="input-file-front">company logo Upload</label>
                                        <input type="file" id="input-file-front" name="company_logo" class="dropify"
                                            data-default-file="{{ asset('public/clientsays_company_logo/' . $data->company_logo) }}">
                                    </div>
...
<script>
    ...
    $('.dropify').dropify();
        $('#description').summernote({
            placeholder: 'Enter clientsays description here...',
            height: 300,
            toolbar: [
                ['style', ['style']],
