    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">Industry Home Slider</h3>

                <div class="row align-items-center mb-3">
                    <div class="col-md-12">
                        <a href="{{ route('industry-home-slider.create') }}" class="btn btn-primary">Add Home Slider</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card border-0 mb-1">
                    <div class="card-body d-flex align-items-center flex-column flex-md-row">
                        <div class="ms-md-4 m-0 mt-4 mt-md-0 text-md-start text-center w-100">
                            <h6 class="mb-3 fw-bold">{{ $item->title }} <span
                                    class="text-muted small fw-light d-block">Reference {{ $item->id }}</span></h6>

                        </div>
                        <div class="ms-auto d-none d-md-flex">
                            <a href="{{ route('industry-home-slider.edit', $item) }}" class="btn btn-warning me-2">Edit</a>
                            <form action="{{ route('industry-home-slider.destroy', $item) }}" method="POST">
                                @csrf
                                @method('DELETE')
