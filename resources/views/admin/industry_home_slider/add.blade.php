...
@section('title', 'Industry Home Slider Add')
    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">Industry Home Slider Add</h3>
            </div>
        </div>
    </div> <!-- Row end -->

    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="{{ route('industry-home-slider.store') }}">
            @csrf
            <div class="col-xl-12 col-lg-8">
                <div class="card mb-3 p-3">
                    <div class="card-header py-3 p-0 d-flex justify-content-between bg-transparent border-bottom-0">
                        <h6 class="mb-0 fw-bold">Home Slider Information</h6>
                    </div>
                    <div class="row g-3 align-items-center">
                        ...
                        <!-- Desktop Images -->
                        <div class="col-md-12">
                            <label class="form-label">Slider Image Desktop</label>
                            <div id="desktopImageInputs">
                                <div class="input-group mb-2">
                                    <input type="file" name="image[]" class="form-control">
                                    <input type="text" name="alt[]" class="form-control" placeholder="Enter Alt Here">
                                    <button type="button" class="btn btn-danger remove-btn" onclick="removeDesktopInput(this)">Remove</button>
                                </div>
                            </div>
                            <button type="button" class="btn btn-primary mt-2" onclick="addDesktopImageInput()">Add More</button>
                        </div>
                        <!-- Mobile Images -->
                        <div class="col-md-12 mt-4">
                            <label class="form-label">Slider Image Mobile</label>
                            <div id="mobileImageInputs">
                                <div class="input-group mb-2">
                                    <input type="file" name="mobile_image[]" class="form-control">
                                    <input type="text" name="mobile_alt[]" class="form-control" placeholder="Enter Alt Here">
...
<script>
    function addDesktopImageInput() {
        const container = document.getElementById('desktopImageInputs');
    ...
    function removeDesktopInput(button) {
        const container = document.getElementById('desktopImageInputs');
        const inputs = container.querySelectorAll('.input-group');
        if (inputs.length > 1) {
            button.parentElement.remove();
        } else {
            alert("At least one desktop image must remain.");
        }
    }
    ...
    function removeMobileInput(button) {
        ...
        if (inputs.length > 1) {
            ...
            alert("At least one mobile image must remain.");
        }
    }
</script>
