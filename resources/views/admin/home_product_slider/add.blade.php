...
@section('title', 'Home Product Slider Add')
    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">Home Product Slider Add</h3>
            </div>
        </div>
    </div> <!-- Row end -->

    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="{{ route('home-product-slider.store') }}">
            @csrf
            <div class="col-xl-12 col-lg-8">
                <div class="card mb-3 p-3">
                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-md-12">
                            <label class="form-label">Title</label>
                            <textarea id="title" name="title" class="form-control summernote" required></textarea>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" id="desktop_alt_tag" name="desktop_alt_tag" class="form-control">
                        </div>
                        <!-- Desktop Images -->
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" id="mobile_alt_tag" name="mobile_alt_tag" class="form-control">
                        </div>
                        <!-- Mobile Images -->
