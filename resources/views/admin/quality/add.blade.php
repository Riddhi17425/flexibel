    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">Add Quality Stages</h3>
            </div>
        </div>
    </div> <!-- Row end -->

    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="{{ route('quality.store') }}">
            @csrf
                ...
                <div class="card mb-3 p-3">
                    ...
                    <div class="row g-3 align-items-center">
                        <div class="col-md-6">
                            ...
                            <input type="text" id="stages" name="stages" required class="form-control">
                        </div>
                        <div class="col-md-6">
