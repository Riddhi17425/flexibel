                    ...
                    <table style="border-radius: 5px;border: 1px solid #DDD;border-spacing: 0px;overflow: hidden;color: #333;font-family:  'Rubik', sans-serif;font-size: 14px;font-weight: 400;line-height: 22px;vertical-align: middle;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style=" border: 1px solid #DDD;padding:9px 8px 8px 23px;">{{ $data['mobile'] }}</td>
                            </tr>
                            @if(isset($data['category_id']) && $data['category_id'] != null && isset($data['category_id']->category) && isset($data['category_id']->category->name))
                                <tr>
                                    <td style=" border: 1px solid #DDD;padding:9px 8px 8px 23px;">Category: </td>
                                    <td style=" border: 1px solid #DDD;padding:9px 8px 8px 23px;">{{ $data['category_id']->category->name ?? null }}</td>
                                </tr>
                            @endif
                            {{-- <tr>
                                <td style=" border: 1px solid #DDD;padding:9px 8px 8px 23px;">Select Country: </td>
                                <td style=" border: 1px solid #DDD;padding:9px 8px 8px 23px;">{{ $data['country'] }}</td>
                            </tr> --}}
                            <tr>
                                <td style=" border: 1px solid #DDD;padding:9px 8px 8px 23px;">Requirements: </td>
