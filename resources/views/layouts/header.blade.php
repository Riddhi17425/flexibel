...
})(window,document,'script','dataLayer','GTM-T2QDMPB3');</script>
...
src="https://www.facebook.com/tr?id=1502808340956968&ev=PageView&noscript=1"
/></noscript>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-T2QDMPB3"
...
<header class="header">
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid position-relative">
            <!-- Navigation Links -->
            <a class="hamburger-btn me-2" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">
                <span></span>
                <span></span>
                <span></span>
            </a>
            ...
            <a class="navbar-brand d-block d-lg-none" href="{{ url('/') }}">
                <img src="{{ asset('public/front/images/logo-white.png')}}" alt="Flexibellows" class="img-fluid logo-white">
                <img src="{{ asset('public/front/images/flexi_header_logo.svg')}}" alt="Flexibellows" class="img-fluid logo-color">
            </a>
            <!-- Navigation Links -->
            <div class="collapse navbar-collapse d-lg-flex justify-content-between" id="navbarNav">
                <ul class="navbar-nav ">
                    ...
                    <!-- Static Links -->
                    <li class="nav-item " id="prod_menu" role="presentation" aria-expanded="true"><a class="nav-link product-link">Products</a></li>
                    <li class="nav-item " id="Ser_menu" role="presentation" aria-expanded="true"><a class="nav-link services-link">Services</a></li>

                </ul>
                <!-- Logo -->
            <a class="navbar-brand" href="{{ url('/') }}">
                <img src="{{ asset('public/front/images/logo-white.png')}}" alt="Flexibel Expansion Joints" class="img-fluid logo-white">
                <img src="{{ asset('public/front/images/flexi_header_logo.svg')}}" alt="Flexibel Expansion Joints" class="img-fluid logo-color">
            </a>
...
<script type="text/javascript">
    function googleTranslateElementInit() {
        new google.translate.TranslateElement({
            pageLanguage: 'en',
            includedLanguages: 'en,ar', // only English and Arabi
    ...
    <div class="offcanvas-body d-flex flex-column justify-content-between">
        ...
        <div id="mainMenu" class="sidebarmain-menu">
            <div class="sidebar-topmenu">
                <div class="main-area">
                    <ul class="nav flex-column menu-list-group">
                        ...
                        <li class="nav-item">
                            <a class="nav-link  product-link d-flex justify-content-between align-items-center" role="button">
                                Products
                                <i class="fa-solid fa-chevron-right fs-6"></i>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link  services-link d-flex justify-content-between align-items-center" role="button">
                                Services
                                <i class="fa-solid fa-chevron-right fs-6"></i>
                            </a>
                        </li>
                        <li class="nav-item"><a class="nav-link " href="{{route('industries')}}">Industries</a></li>
                        
                    </ul>
                </div>
                <div class="secondary-area">
                    <ul class="nav flex-column secondary-list-group">
                        <li class="nav-item"><a class="nav-link  " href="{{route('case-studies')}}">Case Studies</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link  " href="{{ route('current.vacancies') }}">Career </a></li>
            ...
            <div class="sidebar-footer">
                <div class="nav-item">
                            <a class="nav-link " href="https://standards.ejma.org/verify-subscription/cb2df984-119e-4ea7-8960-76f9bbc40ad1" target="_blank">
                            <div>
                                <img src="{{ asset('public/front/images/ejmalogo.png')}}" alt="EJMA Certified Badge" width="80px"><br>
                            <sub class="mb-0" style="text-decoration:underline;">Officially EJMA Approved Standards Subscriber.</sub>
                            </div>
                            </a>
                        </div>
                <div class="row g-2 mt-4 border-top">
                    <div class="col-6"><a href="{{route('contact-us')}}" onclick="setScrollFlag()"><i class="bi bi-telephone"></i>Contact Us</a></div>
                    <div class="col-6"><a class="nav-link " href="#" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Catalogue</a></div>
                </div>
            </div>
                ...
                <div class="sub-menu-item">
                    @foreach ($categories as $index => $category)
                        ...
                        @if ($productCount === 1)
                            ...
                            @endphp
                            <a class="direct-link sub-menu-list d-flex align-items-center mb-3 link-{{ $category->id }} {{ $loop->first ? 'active' : '' }}"
                        ...
                        @else
                            ...
                            <a href="#"
                            class="d-flex align-items-center mb-3 sub-menu-list category-link link-{{ $category->id }} {{ $loop->first ? 'active' : '' }}"
       ...
       @foreach ($categories as $index => $category)
            <div class="sub-product-section sub-products-{{ $category->id }} " style="display:none;">
                ...
                <a href="{{ route('products.by.category', ['category' => $category->url]) }}" class="view-all-btn">View All <i class="fa-solid fa-chevron-right fs-6"></i></a>
                @else
                <a href="{{ route('product.metallic-expansion-joints') }}" class="view-all-btn">View All <i class="fa-solid fa-chevron-right fs-6"></i></a>
                @endif
                <div class="sub-menu-item">
                    @foreach ($category->products as $subProduct)
                        <a class="direct-link sub-menu-list" href="{{ route('product-detail', [ 'url' => $subProduct->url]) }}">
                            <div class="sub-menu-img">
                                
                                <img src="{{ asset('public/products/sidemenu/'.$subProduct->side_menu_image ?? 'public/front/images/favicon.png')}}" class="me-2 img-fluid" width="40" alt="{{ $subProduct->title }}">
                            </div>
                            <div class="sub-menu-title">
