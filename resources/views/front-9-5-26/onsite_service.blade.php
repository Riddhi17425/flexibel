            ...
            <div class="banner_text">
                <div class="">
                    ...
                    <div class="breadcrumb d-none d-md-block">
                        <a href="{{url('/')}}">Home </a><a href="Javascript:void(0)">| Services</a><a href="javascript:void(0)">&nbsp;| Inspection & QA</a>
                    </div>
                </div>
            </div>
         </div>
...
<section class="mt-100">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <p class="sub_head ms-0">Inspection & QA</p>
                <h1 class="main_head text-start">Our Onsite Services</h1>
        ...
        <div class=" prod_slider_wraper">
            <div class="container feature-list">
                <div class="text-center">
                    <h2 class="main_head text-white">The QA & Inspection Process</h2>
                </div>
