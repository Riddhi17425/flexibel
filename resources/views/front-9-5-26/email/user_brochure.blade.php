        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width:600px; margin:0 auto;">
            ...
            <tr class="text-center">
                <td style="padding: 37px 48px 58px 48px; font-family: 'Rubik', sans-serif; color: #333333;">
                    <h2 style=" font-size: 18px;">Thank You – Brochure Request Received.</h2>
                    <p style=" font-size: 14px; line-height: 20px;">
                        Thank you for your interest in our products and for requesting our brochure.
                    </p>
                    <p style=" font-size: 14px; line-height: 20px;">
                        We’ve received your request and our team will send the brochure to your email shortly. If you have any specific questions or would like to speak to our team directly, feel free to reach out.
                    </p>
                    <p style=" font-size: 14px; line-height: 20px;">
